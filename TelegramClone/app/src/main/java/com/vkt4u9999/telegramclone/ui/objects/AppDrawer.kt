package com.vkt4u9999.telegramclone.ui.objects
...
import com.vkt4u9999.telegramclone.utilits.downloadAndSetImage
...
class AppDrawer(val mainActivity: AppCompatActivity, val toolbar: Toolbar) {
    ...
    fun disableDrawer(){
        ...
        //Переопределяем drawer на возврат по стеку назад
    ...
    fun enableDrawer(){
        ...
        //Переопределяем drawer на прежнее поведение
        toolbar.setNavigationOnClickListener{
            mDrawer.openDrawer()
        }
    }
